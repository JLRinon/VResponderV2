...
{
    [RequireComponent(typeof(TextMeshProUGUI))] // Change to TextMeshProUGUI
    [ExecuteInEditMode]
    public class LabelChanger : MonoBehaviour
    {
        // The label to be updated
        public TextMeshProUGUI Label // Change to TextMeshProUGUI
        {
            get
            {
                if (_label == null)
                {
                    _label = gameObject.GetComponent<TextMeshProUGUI>(); // Change to TextMeshProUGUI
                }
                return _label;
            }
        }
        private TextMeshProUGUI _label; // Change to TextMeshProUGUI
